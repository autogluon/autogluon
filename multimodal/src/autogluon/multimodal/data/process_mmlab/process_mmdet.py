...
class MMDetProcessor(MMLabProcessor):
    ...
    def __init__(
        ...
        super().__init__(model=model, collate_func=CollateMMDet, max_img_num_per_col=max_img_num_per_col, missing_value_strategy=missing_value_strategy, requires_column_info=requires_column_info)
