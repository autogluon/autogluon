...
from .constants import CLASSIFICATION, BINARY, MULTICLASS, REGRESSION, OBJECT_DETECTION,\
    TEXT_SIMILARITY, IMAGE_SIMILARITY, IMAGE_TEXT_SIMILARITY, NER, NAMED_ENTITY_RECOGNITION,\
    FEATURE_EXTRACTION, ZERO_SHOT_IMAGE_CLASSIFICATION, FEW_SHOT_TEXT_CLASSIFICATION,\
    OCR_TEXT_DETECTION, OCR_TEXT_RECOGNITION, IMAGE, IMAGE_BYTEARRAY, TEXT, CATEGORICAL, NUMERICAL, ROIS,\
    TEXT_NER, NER_ANNOTATION
