...
MEDIUM_QUALITY_FASTER_INFERENCE = "medium_quality_faster_inference"
BEST_QUALITY = "best_quality"
ALL_MODEL_QUALITIES = [HIGH_QUALITY_FAST_INFERENCE, MEDIUM_QUALITY_FASTER_INFERENCE, BEST_QUALITY, DEFAULT]
