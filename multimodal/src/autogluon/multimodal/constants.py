...
EVALUATION_METRICS = {
    CLASSIFICATION: [ACCURACY, ACC, OVERALL_ACCURACY, QUADRATIC_KAPPA, ROC_AUC, CROSS_ENTROPY],  # TODO
    BINARY: [ROC_AUC, AVERAGE_PRECISION, F1, ACCURACY, ACC, OVERALL_ACCURACY, QUADRATIC_KAPPA, CROSS_ENTROPY],
    MULTICLASS: [ACCURACY, ACC, OVERALL_ACCURACY, QUADRATIC_KAPPA, CROSS_ENTROPY, F1_MACRO, F1_MiCRO, F1_WEIGHTED],
    REGRESSION: [RMSE, ROOT_MEAN_SQUARED_ERROR, PEARSONR, SPEARMANR, R2],
    ...
    ZERO_SHOT_IMAGE_CLASSIFICATION: [],  # TODO: No eval metrics needed for zero shot?
    ...
    FEW_SHOT_CLASSIFICATION: [ACCURACY, ACC, OVERALL_ACCURACY, QUADRATIC_KAPPA, ROC_AUC, CROSS_ENTROPY],
...
VALIDATION_METRICS = {
    ...
    REGRESSION: [RMSE, ROOT_MEAN_SQUARED_ERROR, PEARSONR, SPEARMANR],
    NER: [NER_TOKEN_F1],
