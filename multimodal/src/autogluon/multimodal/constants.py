...
EVALUATION_METRICS = {
    ...
    FEW_SHOT_CLASSIFICATION: METRICS[BINARY].keys() + METRICS[MULTICLASS].keys(),
...
VALIDATION_METRICS = {
    problem_type: [m for m in metrics if m in VALID_METRICS] for problem_type, metrics in EVALUATION_METRICS.items()
}
