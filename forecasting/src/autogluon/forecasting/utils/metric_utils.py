...
def check_get_evaluation_metric(
    ...
    name is available in autogluon.forecasting, and optionally raises
    ...
    raise_if_not_available: bool
        ...
        available in autogluon.forecasting. Otherwise, the default metric name will be
        returned instead of the requested metric.

    Returns
    -------
    checked_metric_name: str
        The requested metric name if it is available in autogluon.forecasting.
    """
