...
def test_included_model_types():
    expected_config = dict(excluded_model_types=['XT', 'KNN', 'GBM', 'CAT', 'XGB', 'NN_MXNET', 'NN_TORCH', 'LR', 'FASTAI', 'TRANSF', 'AG_TEXT_NN', 'AG_IMAGE_NN', 'AG_AUTOMM_NN', 'FASTTEXT',
    ...
    expected_config = dict(excluded_model_types=['XT', 'KNN', 'GBM', 'CAT', 'XGB', 'NN_MXNET', 'NN_TORCH', 'FASTAI', 'TRANSF', 'AG_TEXT_NN', 'AG_IMAGE_NN', 'AG_AUTOMM_NN', 'FASTTEXT',
                                                 'IM_RULEFIT', 'IM_GREEDYTREE', 'IM_RULELIST', 'IM_OPTIMALTREE', 'IM_BOOSTEDRULES', 'VW'])
