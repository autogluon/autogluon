...
def test_included_model_types():
    expected_config = dict(excluded_model_types=['XT', 'KNN', 'GBM', 'CAT', 'XGB', 'NN_MXNET', 'NN_TORCH', 'LR', 'FASTAI', 'WIDEDEEPNN', 'TRANSF', 'AG_TEXT_NN', 'AG_IMAGE_NN', 'FASTTEXT',
    ...
    assert sorted(actual_config) == sorted(expected_config)
    ...
    expected_config = dict(excluded_model_types=['XT', 'KNN', 'GBM', 'CAT', 'XGB', 'NN_MXNET', 'NN_TORCH', 'FASTAI', 'WIDEDEEPNN', 'TRANSF', 'AG_TEXT_NN', 'AG_IMAGE_NN', 'FASTTEXT',
                                                 'IM_RULEFIT', 'IM_GREEDYTREE', 'IM_RULELIST', 'IM_OPTIMALTREE', 'IM_BOOSTEDRULES', 'VW'])
