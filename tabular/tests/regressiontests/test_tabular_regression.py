...
tests = [
    ...
    {   # Default regression model on a small dataset
        ...
        'expected_score_range' : {
                  ...
                  'RandomForestMSE': (-9.65, 0.01),
                  'WeightedEnsemble_L2': (-5.65, 0.01),
                  'XGBoost': (-10.8, 0.01),
        },
    },
    ...
    {   # High quality preset on small datset.
        ...
        'expected_score_range' : {
                  ...
                  'ExtraTreesMSE_BAG_L1': (np.nan, np.nan),
                  'ExtraTreesMSE_BAG_L1_FULL': (-7.54, 0.01),
                  'KNeighborsDist_BAG_L1': (np.nan, np.nan),
                  'KNeighborsDist_BAG_L1_FULL': (-8.21, 0.01),
                  'KNeighborsUnif_BAG_L1': (np.nan, np.nan),
                  ...
                  'RandomForestMSE_BAG_L1': (np.nan, np.nan),
                  'RandomForestMSE_BAG_L1_FULL': (-9.53, 0.01),
    ...
    {   # Best quality preset on small datset.
        ...
        'expected_score_range' : {
                  ...
                  'ExtraTreesMSE_BAG_L1' : (-7.54, 0.01),
                  ...
                  'RandomForestMSE_BAG_L1' : (-9.53, 0.01),
    ...
    {   # Default regression model different metric
        ...
        'expected_score_range' : {
                  ...
                  'RandomForestMSE': (-6.95, 0.01),
                  'WeightedEnsemble_L2': (-4.04, 0.01),
                  'XGBoost': (-8.32, 0.01),
    ...
    {   # Default classification model on a small dataset
        ...
        'expected_score_range' : {
            'CatBoost': (0.24, 0.01),
            'ExtraTreesEntr' : (0.32, 0.01), 
            'ExtraTreesGini' : (0.32, 0.01), 
            'KNeighborsDist' : (0.33, 0.01), 
            'KNeighborsUnif' : (0.32, 0.01), 
            'LightGBM' : (0.19, 0.01), 
            'LightGBMLarge' : (0.26, 0.01), 
            'LightGBMXT' : (0.23, 0.01), 
            'NeuralNetFastAI' : (0.34, 0.01), 
            'NeuralNetTorch' : (0.23, 0.01), 
            'RandomForestEntr' : (0.30, 0.01), 
            'RandomForestGini' : (0.29, 0.01), 
            'WeightedEnsemble_L2' : (0.34, 0.01), 
            'XGBoost' : (0.22, 0.01), 
        }
    },
