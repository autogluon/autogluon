...
def get_searchspace_binary():
    spaces = {
        ...
        'layers': ag.space.Categorical(None, [200, 100], [200], [500], [1000], [500, 200], [50, 25], [1000, 500], [200, 100, 50], [500, 200, 100], [1000, 500, 200]),
        'emb_drop': ag.space.Real(0.0, 0.5, default=0.1),
        'ps': ag.space.Real(0.0, 0.5, default=0.1),
        'bs': ag.space.Categorical(256, 64, 128, 512, 1024, 2048, 4096),
        'lr': ag.space.Real(5e-5, 1e-1, default=1e-2, log=True),
...
def get_searchspace_quantile():
    ...
    spaces.update({'alpha': ag.space.Categorical(0.001, 0.01, 0.1, 1.0)})
    return spaces
