# Commercially licensable portfolio: 7 configs, no TabPFN. Used by the `extreme_quality` preset.
...
hyperparameter_portfolio_commercial_2026_08_05 = {
    ...
    "GBM": [
        {
            "ag_args": {"name_suffix": "_r200", "priority": -4},
        ...
        },
        {
            ...
            "num_leaves": 16,
            "ag_args": {"name_suffix": "_r8", "priority": -5},
            "ag.min_rows": 50000,
        },
    ],
    "CAT": [{"ag_args": {"priority": -6}, "ag.min_rows": 50000}],
    "REALMLP": [
        {
            "act": "mish",
            "embedding_size": 16,
