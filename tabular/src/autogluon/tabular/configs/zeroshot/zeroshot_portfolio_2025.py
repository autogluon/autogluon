...
hyperparameter_portfolio_zeroshot_2025_small = {
	"TABPFNV2": [
		...
		{
			"ag_args": {'name_suffix': '_r175', 'priority': -2},
			"average_before_softmax": True,
			"classification_model_path": 'tabpfn-v2-classifier-gn2p4bpt.ckpt',
			"inference_config/FINGERPRINT_FEATURE": True,
			"inference_config/OUTLIER_REMOVAL_STD": 12.0,
			"inference_config/POLYNOMIAL_FEATURES": 50,
			"inference_config/PREPROCESS_TRANSFORMS": [{'append_original': False, 'categorical_name': 'numeric', 'global_transformer_name': 'svd', 'name': 'none', 'subsample_features': 0.95}, {'append_original': False, 'categorical_name': 'numeric', 'global_transformer_name': 'svd', 'name': 'power', 'subsample_features': 0.95}],
			"inference_config/REGRESSION_Y_PREPROCESS_TRANSFORMS": ['kdi_alpha_0.3'],
			"inference_config/SUBSAMPLE_SAMPLES": 0.99,
			"model_type": 'single',
			"n_ensemble_repeats": 4,
		...
		{
			"ag_args": {'name_suffix': '_r94', 'priority': -4},
			"average_before_softmax": True,
		...
		{
			"ag_args": {'name_suffix': '_r4', 'priority': -5},
			"average_before_softmax": True,
			"classification_model_path": 'tabpfn-v2-classifier-gn2p4bpt.ckpt',
			"inference_config/FINGERPRINT_FEATURE": True,
			"inference_config/OUTLIER_REMOVAL_STD": 12.0,
			"inference_config/POLYNOMIAL_FEATURES": 'no',
			"inference_config/PREPROCESS_TRANSFORMS": [{'append_original': True, 'categorical_name': 'none', 'global_transformer_name': None, 'name': 'safepower', 'subsample_features': 0.99}],
		...
		{
			"ag_args": {'name_suffix': '_r181', 'priority': -10},
			"average_before_softmax": False,
		...
		{
			"ag_args": {'name_suffix': '_r54', 'priority': -11},
			"average_before_softmax": True,
			"classification_model_path": 'tabpfn-v2-classifier-gn2p4bpt.ckpt',
			"inference_config/FINGERPRINT_FEATURE": True,
			"inference_config/OUTLIER_REMOVAL_STD": 9.0,
			"inference_config/POLYNOMIAL_FEATURES": 50,
			"inference_config/PREPROCESS_TRANSFORMS": [{'append_original': False, 'categorical_name': 'ordinal_very_common_categories_shuffled', 'global_transformer_name': 'svd', 'name': 'norm_and_kdi', 'subsample_features': 0.99}],
			"inference_config/REGRESSION_Y_PREPROCESS_TRANSFORMS": ['kdi_alpha_0.6'],
			"inference_config/SUBSAMPLE_SAMPLES": 0.99,
			"model_type": 'single',
			"n_ensemble_repeats": 4,
		...
		{
			"ag_args": {'name_suffix': '_r91', 'priority': -12},
			"average_before_softmax": False,
			"classification_model_path": 'tabpfn-v2-classifier-od3j1g5m.ckpt',
			"inference_config/FINGERPRINT_FEATURE": False,
			"inference_config/OUTLIER_REMOVAL_STD": 12.0,
			"inference_config/POLYNOMIAL_FEATURES": 50,
			"inference_config/PREPROCESS_TRANSFORMS": [{'append_original': False, 'categorical_name': 'none', 'global_transformer_name': 'svd', 'name': 'quantile_uni_coarse', 'subsample_features': -1}],
			"inference_config/REGRESSION_Y_PREPROCESS_TRANSFORMS": ['kdi_alpha_1.0'],
			"inference_config/SUBSAMPLE_SAMPLES": None,
			"model_type": 'single',
			"n_ensemble_repeats": 4,
			"regression_model_path": 'tabpfn-v2-regressor-09gpqh39.ckpt',
			"softmax_temperature": 0.8,
		},
	],
	"GBM": [
		{
			"ag_args": {'name_suffix': '_r33', 'priority': -3},
		...
		{
			"ag_args": {'name_suffix': '_r21', 'priority': -13},
	...
	"CAT": [
		{
			"ag_args": {'name_suffix': '_c1', 'priority': -6},
		},
		{
			"ag_args": {'name_suffix': '_r51', 'priority': -14},
			"boosting_type": 'Plain',
		...
		{
			"ag_args": {'name_suffix': '_r10', 'priority': -15},
			"boosting_type": 'Plain',
			"bootstrap_type": 'Bernoulli',
		...
		{
			"ag_args": {'name_suffix': '_r24', 'priority': -19},
			"boosting_type": 'Plain',
			"bootstrap_type": 'Bernoulli',
		...
		{
			"ag_args": {'name_suffix': '_r91', 'priority': -21},
			"boosting_type": 'Plain',
			"bootstrap_type": 'Bernoulli',
	...
	"TABM": [
		{
			"ag_args": {'name_suffix': '_r184', 'priority': -7},
			"amp": False,
			"arch_type": 'tabm-mini',
			"batch_size": 'auto',
			"d_block": 864,
		...
		{
			"ag_args": {'name_suffix': '_r69', 'priority': -9},
			"amp": False,
			"arch_type": 'tabm-mini',
			"batch_size": 'auto',
			"d_block": 848,
		...
		{
			"ag_args": {'name_suffix': '_r52', 'priority': -16},
			"amp": False,
			"arch_type": 'tabm-mini',
			"batch_size": 'auto',
			"d_block": 1024,
		...
		{
			"ag_args": {'name_suffix': '_r191', 'priority': -17},
			"amp": False,
			"arch_type": 'tabm-mini',
			"batch_size": 'auto',
			"d_block": 864,
		...
		{
			"ag_args": {'name_suffix': '_c1', 'priority': -18},
		},
		{
			"ag_args": {'name_suffix': '_r49', 'priority': -24},
			"amp": False,
			"arch_type": 'tabm-mini',
			"batch_size": 'auto',
			"d_block": 640,
	...
	"XGB": [
		{
			"ag_args": {'name_suffix': '_r171', 'priority': -20},
		...
		{
			"ag_args": {'name_suffix': '_r40', 'priority': -22},
