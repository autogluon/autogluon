...
from ...models import LGBModel, CatBoostModel, XGBoostModel, RFModel, XTModel, KNNModel, LinearModel,\
    TabularNeuralNetModel, NNFastAiTabularModel, FastTextModel, AGTextPredictionModel
...
MODEL_TYPES = dict(
    ...
    AG_TEXT_NN=AGTextPredictionModel,
...
DEFAULT_MODEL_NAMES = {
    ...
    AGTextPredictionModel: 'AGTextNeuralNetwork',
