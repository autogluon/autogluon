...
class AutoTrainer(AbstractTrainer):
    ...
    def train(self, X_train, y_train, X_val=None, y_val=None, X_unlabeled=None, hyperparameter_tune=True, feature_prune=False, holdout_frac=0.1, hyperparameters=None, ag_args_fit=None, excluded_model_types=None, time_limit=None, **kwargs):
        ...
        self._train_multi_and_ensemble(X_train, y_train, X_val, y_val, X_unlabeled, hyperparameters=self.hyperparameters, hyperparameter_tune=hyperparameter_tune, feature_prune=feature_prune, time_limit=time_limit)
