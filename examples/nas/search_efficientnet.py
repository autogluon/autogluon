...
@ag.obj(
    width_coefficient=autogluon.core.space.Categorical(1.1, 1.2),
    depth_coefficient=autogluon.core.space.Categorical(1.1, 1.2),
)
...
results = task.fit('imagenet', net=EfficientNetB1(), search_strategy='grid',
                   optimizer=autogluon.core.optimizer.SGD(learning_rate=1e-1, momentum=0.9, wd=1e-4),
                   batch_size=32)
