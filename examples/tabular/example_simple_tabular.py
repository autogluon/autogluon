...
predictor = task.fit(train_data=train_data, label=label_column, output_directory=savedir, hyperparameter_tune=False) # Since tuning_data = None, AutoGluon automatically determines train/validation split.
...
predictor = task.load(savedir) # We reload predictor here just to demonstrate how to load previously-trained predictor from file.
