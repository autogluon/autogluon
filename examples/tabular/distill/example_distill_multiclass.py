...
from autogluon.extra.utils.tabular.ml.constants import MULTICLASS
...
predictor.distill(time_limits=time_limits, teacher_preds='soft', augment_method=None, models_name_suffix='know')  # distillation without data augmentation.
