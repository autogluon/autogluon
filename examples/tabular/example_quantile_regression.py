...
for i in range(num_quantiles // 2):
    ...
    print("Desired coverage = {:.2f} => Actual coverage of predicted interval from [quantile {}, quantile {}] = {:.2f}".format(target_coverage, low_quantile, high_quantile, pred_coverage))
