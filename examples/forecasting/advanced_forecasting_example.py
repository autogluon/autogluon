...
predictor = ForecastingPredictor(path=path, eval_metric=eval_metric).fit(
    train_data,
    prediction_length,
...
predictions = predictor.predict(
    train_data, static_features=static_features, quantiles=[0.5]
)
time_series_id = "Afghanistan_"
print(predictions[time_series_id])
print(
    ForecastingPredictor.evaluate_predictions(
