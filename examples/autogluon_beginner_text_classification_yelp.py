...
if __name__ == '__main__':
    ...
    dataset = task.Dataset(name='yelp', train_path='/home/ubuntu/AutoGluon/data/yelp/train.json',
                           val_path='/home/ubuntu/AutoGluon/data/yelp/dev.json', data_format='json')
    results = task.fit(dataset,
                       nets=nets_to_search,
                       optimizers=optims,
                       stop_criterion=default_stop_criterion,
                       resources_per_trial=default_resources_per_trial,
                       savedir='/home/ubuntu/AutoGluon/checkpoint/yelp')
