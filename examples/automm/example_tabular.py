...
def main(args):
    ...
    ### model training
    predictor.fit(
        train_data=train_data.data, tuning_data=val_data.data, seed=args.seed, hyperparameters=hyperparameters
    )

    ### model inference
    predictor.evaluate(data=test_data.data, metrics=[test_data.metric])
