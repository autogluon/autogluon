...
@pytest.mark.parametrize(
    "checkpoint_name", ["swin_base_patch4_window7_224", "vit_small_patch16_384", "resnet18", "legacy_seresnet18",]
)
...
def test_numerical_transformer_init(embedding_arch):
    ...
    y = model.forward({model.numerical_key: torch.ones(1, in_features),})[model.prefix]  # synthetic data
