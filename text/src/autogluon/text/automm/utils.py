...
from .constants import (
    ...
    ROC_AUC, AVERAGE_PRECISION, LOG_LOSS,S3_PREFIX
)
from .presets import (
    list_model_presets,
    get_preset,
...
def sha1sum(filename):
    ...
    Reference: https://github.com/sxjscience/automl_multimodal_benchmark/blob/main/multimodal_text_benchmark/src/auto_mm_bench/utils.py
    Parameters
    ----------
    filename
        Name of the file
