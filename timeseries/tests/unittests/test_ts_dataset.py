...
def test_given_dfs_are_identical_when_hashing_then_hash_is_identical():
    ...
    assert (df.hash_each_item().values == df_copy.hash_each_item().values).all()
...
def test_given_item_id_is_different_when_hashing_then_hash_is_identical():
    ...
    assert (df1.hash_each_item().values == df2.hash_each_item().values).all()
...
def test_when_hashing_then_item_id_order_is_preserved():
    ...
    assert df.hash_each_item().index.equals(df._item_index)
...
def test_when_items_are_permuted_then_hash_values_are_permuted():
    ...
    assert (df1.hash_each_item().loc[new_order].values == df2.hash_each_item().values).all()
