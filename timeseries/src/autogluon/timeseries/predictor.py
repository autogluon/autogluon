...
class TimeSeriesPredictor:
    ...
    def backtest_predictions(
        ...
        *,
        ...
        """
        Run rolling / backtest-style prediction for a single model and return
        one TimeSeriesDataFrame per validation window.
        """
        ...
    ...
    def backtest_predictions(
        ...
        *,
        ...
        """
        Run rolling / backtest-style prediction for multiple models and return
        a dict mapping model name -> list of TimeSeriesDataFrame (one per window).
        """
        ...
