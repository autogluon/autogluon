...
AutoGluon v1.5 adds support for [Chronos-2](https://huggingface.co/amazon/chronos-2), our latest generation of foundation models for time series forecasting. Chronos-2 supports **univariate**, **multivariate**, and **covariate-based** forecasting in a single model, including native handling of past and known future covariates. It produces multi-step quantile forecasts and is designed for strong out-of-the-box performance on new datasets.
