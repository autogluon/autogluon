...
### New Features
* PDF Document Classification. See [tutorial](https://auto.gluon.ai/dev/tutorials/multimodal/document/pdf_classification.html) @cheungdaven (#2864, #3043)
* Open Vocabulary Object Detection. See [tutorial](https://auto.gluon.ai/dev/tutorials/multimodal/object_detection/quick_start/quick_start_ovd.html) @FANGAreNotGnu (#3164)
