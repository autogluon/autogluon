...
@geoalgo for co-authoring [TabRepo](https://github.com/autogluon/tabrepo) to enable Zeroshot-HPO,
@ddelange for helping to add Python 3.11 support,
and @mlgowacki100 for providing numerous feedback and suggestions.
...
Together, they lead to a **75% win-rate compared to 0.8 with faster inference speed, lower disk usage, and higher stability.**
...
We show that it can (1) profoundly improve the performance of multimodal deep learning architectures, 
