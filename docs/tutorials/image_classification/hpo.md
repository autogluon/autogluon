...
We begin by letting AutoGluon know that [ImageClassification](/api/autogluon.core.task.html#autogluon.core.task.ImageClassification) is the task of interest: 
