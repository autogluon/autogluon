    ...
    **kwargs
    ...
    def _hyperparameter_tune(
        ...
        **kwargs
        ...
        # user_specified_resources_per_trial = hpo_executor.hyperparameter_tune_kwargs.get('resources_per_trial', None)
        # if user_specified_resources_per_trial is None:
        #     fold_estimate_memory_usage = None
        #     num_folds_in_parallel_with_mem = math.inf
        ...
        #     minimum_gpu_per_trial = total_gpu_available // num_trials_in_parallel
        # else:
        #     minimum_cpu_per_trial = user_specified_resources_per_trial['num_cpus']
        #     minimum_gpu_per_trial = user_specified_resources_per_trial['num_gpus']
