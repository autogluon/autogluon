...
DEPENDENT_PACKAGES = {
    ...
    "huggingface_hub[torch]": ">=1.3,<2.0",  # >=1.3 required by transformers>=5.3. Major version cap
    "accelerate": ">=1.1.0,<2.0",  # >=1.1.0 required by transformers>=5.3. Major version cap
