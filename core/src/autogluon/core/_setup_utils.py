...
DEPENDENT_PACKAGES = {
    ...
    "torch": ">=2.1,<2.2",  # "<{N+2}" upper cap, sync with common/src/autogluon/common/utils/try_import.py
    "lightning": ">=2.1,<2.2",  # "<{N+2}" upper cap
    "pytorch_lightning": ">=2.1,<2.2",  # "<{N+2}" upper cap, capping `lightning` does not cap `pytorch_lightning`!
