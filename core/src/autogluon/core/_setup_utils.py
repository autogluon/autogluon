...
DEPENDENT_PACKAGES = {
    ...
    "torch": ">=2.2,<2.9",  # Major version cap, sync with common/src/autogluon/common/utils/try_import.py. torchvision version in multimodelal/setup.py can effectively constrain version as well 
