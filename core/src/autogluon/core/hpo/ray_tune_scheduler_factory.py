...
class SchedulerFactory:
    ...
    def get_scheduler(scheduler_name: str, user_init_args, **kwargs):
        assert scheduler_name in SchedulerFactory.scheduler_presets, f'{scheduler_name} is not a valid option. Options are {SchedulerFactory.scheduler_presets.keys()}'
