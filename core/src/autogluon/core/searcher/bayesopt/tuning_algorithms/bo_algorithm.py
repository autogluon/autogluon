...
class BayesianOptimizationAlgorithm(NamedTuple, NextCandidatesAlgorithm):
    ...
    def _get_next_candidates(self, num_candidates: int,
        ...
        # locally optimized
        logger.log(15, "BO Algorithm: Generating initial candidates.")
        ...
        logger.log(15, "BO Algorithm: Scoring (and reordering) candidates.")
        ...
        logger.log(15, "BO Algorithm: Selecting final set of candidates.")
