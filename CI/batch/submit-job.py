...
job_type_info = {
    'CI-CPU': {
        'job_definition': 'autogluon-ci-cpu:4',
        'job_queue': 'CI-CPU'
    },
    'CI-GPU': {
    ...
    'CI-WASM': {
        'job_definition': 'autogluon-ci-wasm:2',
        'job_queue': 'CI-CPU'
    },
    'CI-MULTI-GPU': {
        'job_definition': 'autogluon-ci-multi-gpu:7',
    ...
    'CI-WASM-PUSH': {
        'job_definition': 'autogluon-ci-wasm-push:3',
        'job_queue': 'CI-CPU'
    },
    'CI-MULTI-GPU-PUSH': {
        'job_definition': 'autogluon-ci-multi-gpu-push:3',
        'job_queue': 'CI-MULTI-GPU'
    },
}
