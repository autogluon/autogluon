...
class NNFastAiTabularModel(AbstractModel):
    ...
    def fit(self, X_train, Y_train, X_test=None, Y_test=None, **kwargs):
        ...
        early_stopping_fn = partial(EarlyStoppingCallback, monitor=objective_func_name_to_monitor, mode=objective_optim_mode, min_delta=0.01, patience=self.params['nn.tabular.early.stopping.patience'])
