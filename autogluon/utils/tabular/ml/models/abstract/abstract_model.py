...
class AbstractModel:
    ...
    def _set_default_auxiliary_params(self):
        ...
        default_auxiliary_params = dict(
            ...
            ignored_feature_types_special=None,  # List, drops any features in `self.feature_types_metadata.feature_types_special[type]` for type in `ignored_feature_types_special`. | Currently undocumented in task.
            ignored_feature_types_raw=None,  # List, drops any features in `self.feature_types_metadata.feature_types_raw[type]` for type in `ignored_feature_types_raw`. | Currently undocumented in task.
        )
    ...
    def preprocess(self, X):
        if self.features is not None:
            ...
            ignored_feature_types_raw = self.params_aux.get('ignored_feature_types_raw', None)
            ...
            ignored_feature_types_special = self.params_aux.get('ignored_feature_types_special', None)
