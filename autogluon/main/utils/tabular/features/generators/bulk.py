...
class BulkFeatureGenerator(AbstractFeatureGenerator):
    ...
    **kwargs :
    ...
    >>> from autogluon.main.utils.tabular.features.generators import AsTypeFeatureGenerator, BulkFeatureGenerator, CategoryFeatureGenerator, DropDuplicatesFeatureGenerator, FillNaFeatureGenerator, IdentityFeatureGenerator
