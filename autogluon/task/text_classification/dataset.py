...
class Dataset(dataset.Dataset):
    ...
    def __init__(self, name: AnyStr = None, train_path: AnyStr = None, val_path: AnyStr = None, lazy: bool = True,
                 transform: TextDataTransform = None, batch_size: int = 32, data_format='json', num_workers=None,
                 **kwargs):
    ...
    self.num_workers = cpu_count() if num_workers is None else int(
        num_workers / 2)  # dividing by 2 to use for train and valid dataloaders
