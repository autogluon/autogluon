...
7. To spin up the platform tests, which test autogluon among macos and windows, comment on the PR with `/platform_tests`. It is recommended to run the platform tests only after you have passed the default CI.
