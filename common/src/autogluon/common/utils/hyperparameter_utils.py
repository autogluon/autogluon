...
def get_hyperparameter_str_deprecation_msg() -> str:
    extra_msg = (
        ...
        "Support for hyperparameter shorthands via strings is deprecated and will raise an exception starting in `autogluon==1.3`"
        "\nTo avoid this, you can still train the desired 'GBMLarge' model "
        "by editing your hyperparameters dictionary, replacing 'GBMLarge' with the following:\n"
        """{
    "learning_rate": 0.03,
    "num_leaves": 128,
