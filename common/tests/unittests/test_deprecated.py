...
def test_should_deprecate_warning(mock_ag_version_mgr, mock_version):
...
def test_should_raise_deprecate_error(mock_ag_version_mgr, mock_version):
    with mock_ag_version_mgr(mock_version):
...
def test_should_not_deprecate(mock_ag_version_mgr, mock_version):
    with mock_ag_version_mgr(mock_version):
