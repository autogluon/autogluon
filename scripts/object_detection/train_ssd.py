...
parser = argparse.ArgumentParser(description='AutoGluon Object Detection')
parser.add_argument('--data', default='voc', type=str,
                    help='options are: voc')
parser.add_argument('--nets', default='ssd_512_resnet50_v1_coco', type=str,
                    help='list of nets to run (default: ssd_512_resnet50_v1_coco,'
...
parser.add_argument('--max_num_gpus', default=4, type=int,
                    help='number of gpus per trial')
parser.add_argument('--max_num_cpus', default=32, type=int,
...
parser.add_argument('--lr_step', default=80, type=int,
...
if __name__ == '__main__':
    ...
    logging_handlers.append(logging.FileHandler(
        '%s/train_ssd_%s.log' % (logdir, args.data)))
    if args.debug:
    ...
    logger.info('=========================')
    logger.info('Total time cost: %.2f s' % results.time)
    logger.info('=========================')
