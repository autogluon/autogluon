...
def test_comparison_gpy():
    ...
    fname_msk = 'tests/unittests/bayesopt/gpmxnet/numcomp/{}_{}_{}.pickle'
    num_train = 200
    num_grid = 200
    ...
    if do_branin:
        ...
        with open(fname, 'rb') as handle:
            branin = pickle.load(handle)
        fname = fname_msk.format(data_name, num_train, 'gpy')
        with open(fname, 'rb') as handle:
            branin_gpy = pickle.load(handle)
        # --------------------------------------------------------------------
        # bb_cls = Branin
    ...
    if do_threehump:
        ...
        fname = fname_msk.format(data_name, num_train, 'data')
        with open(fname, 'rb') as handle:
            threehump = pickle.load(handle)
        fname = fname_msk.format(data_name, num_train, 'gpy')
        with open(fname, 'rb') as handle:
            threehump_gpy = pickle.load(handle)
        # --------------------------------------------------------------------
    ...
    if do_ackley:
        ...
        fname = fname_msk.format(data_name, num_train, 'data')
        with open(fname, 'rb') as handle:
            ackley = pickle.load(handle)
        fname = fname_msk.format(data_name, num_train, 'gpy')
        with open(fname, 'rb') as handle:
            ackley_gpy = pickle.load(handle)
        # --------------------------------------------------------------------
        # bb_cls = Ackley
